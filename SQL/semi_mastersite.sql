...
CREATE TABLE IF NOT EXISTS `semi_admin` (
  ...
  `Power` int(1) NOT NULL COMMENT '权限'
...
INSERT INTO `semi_admin` (`ID`, `Name`, `Password`, `Power`) VALUES
(1, 'admin', '9578f209c8e40b256c3ee9030bdaacbe', 9);
...
(1, 5, 1476954272, 1, 1, '<p>qwqweqwe</p>'),
...
(1, 'SEMI大半导体产业网', 'SEMI大半导体产业网', 'SEMI大半导体产业网');
