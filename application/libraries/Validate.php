...
class Validate{
	...
	private $validator = array(
		...
		"useranme"=>'/^[a-zA-Z0-9_]{4,16}$/',
		"password"=>'/^[A-Za-z0-9_-]{6,16}$/',
		"vcode"=>'/^[a-zA-Z0-9]{4}$/',//验证码
		"pic"=>'/^([a-zA-Z0-9]{32})+(.jpg|.jpeg|.gif|.png|.JPG|.JPEG|.GIF|.PNG)$/',//上传图片
		"date"=>'/^[0-9]{4}-[0-9]{2}-[0-9]{2}$/',//日期
		"sex"=>'/^(1|2)$/',//性别
		"hotel"=>'/^(1|3|4|5)$/',//酒店要求
		"nickname"=>'/^[\x80-\xffA-Za-z0-9_-]{2,20}$/',//昵称
		"cnname"=>'/^[\x80-\xff]{2,20}$/',//中文名
		"ordernum"=>'/^[a-zA-Z0-9_]{2,20}$/',//订单号
	);
