...
<body class="fixed-sidebar full-height-layout gray-bg" style="overflow:hidden">
    <div id="wrapper">
                ...
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            <span><img alt="image" class="img-circle" src="<?=$siteurl;?>admin_file/img/profile_small.jpg" /></span>
                            ...
                            <ul class="dropdown-menu animated fadeInRight m-t-xs">
                                <li><a class="J_menuItem" href="<?=$siteurl;?>admin/site/admin_edit_pw/">密码修改</a>
                                </li>
                                <li class="divider"></li>
                                <li><a href="<?=$siteurl;?>admin/root/logout/">安全退出</a>
                                </li>
                            </ul>
                        </div>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-messages">
                                <li class="m-t-xs">
                                    <div class="dropdown-messages-box">
                                        <a href="profile.html" class="pull-left">
                                            <img alt="image" class="img-circle" src="<?=$siteurl;?>admin_file/img/a7.jpg">
                                        </a>
                                ...
                                <li>
                                    <div class="dropdown-messages-box">
                                        <a href="profile.html" class="pull-left">
                                            <img alt="image" class="img-circle" src="<?=$siteurl;?>admin_file/img/a4.jpg">
                                        </a>
                                        <div class="media-body ">
            ...
            <div class="row content-tabs">
                ...
                <a href="<?=$siteurl;?>admin/root/logout/" class="roll-nav roll-right J_tabExit"><i class="fa fa fa-sign-out"></i> 退出</a>
            </div>
            <div class="row J_mainContent" id="content-main">
                <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="<?=$siteurl;?>admin/root/emptypage/" frameborder="0" data-id="index_v1.html" seamless></iframe>
            </div>
            <div class="footer">
                <div class="pull-right">&copy; 2014-2016 <a href="http://www.sinocontact.com/" target="_blank">SinoContact</a>
                </div>
            </div>
        </div>
        <!--右侧部分结束-->
                    ...
                    <div id="tab-2" class="tab-pane">
                        ...
                        <div>
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="<?=$siteurl;?>admin_file/img/a1.jpg">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="<?=$siteurl;?>admin_file/img/a2.jpg">
                                    </div>
                                    <div class="media-body">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="<?=$siteurl;?>admin_file/img/a3.jpg">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="<?=$siteurl;?>admin_file/img/a4.jpg">
                                    </div>
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="<?=$siteurl;?>admin_file/img/a8.jpg">
                                    </div>
                                    <div class="media-body">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="<?=$siteurl;?>admin_file/img/a7.jpg">
                                    </div>
                                    <div class="media-body">
    ...
    <script src="<?=$siteurl;?>admin_file/js/plugins/metisMenu/jquery.metisMenu.js"></script>
    <script src="<?=$siteurl;?>admin_file/js/plugins/slimscroll/jquery.slimscroll.min.js"></script>
    <script src="<?=$siteurl;?>admin_file/js/plugins/layer/layer.min.js"></script>
    <script src="<?=$siteurl;?>admin_file/js/hplus.min.js?v=4.1.0"></script>
    <script type="text/javascript" src="<?=$siteurl;?>admin_file/js/contabs.min.js"></script>
    <script src="<?=$siteurl;?>admin_file/js/plugins/pace/pace.min.js"></script>
</body>
</html>
